...
public class ProductViewActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (_price != null && _price.length() != 0 && _price != "" && _discount != null && _discount.length() != 0 && _discount != "") {
            ...
            disPercent = (int) Math.round((discount_m / M) * 100);
        ...
        price.setText(Utils.getStrikeThroughTextForProductAdapters(_price,_discount,disPercent));
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String params = "_id="+_id+"&_title="+_title+"&_image="+_image+"&_description="+_description+"&_price="+_price+"&_currency="+_currency+"&_discount="+_discount+"&_attribute="+_attribute;
                try{
                    FirebaseDynamicLinks.getInstance().createDynamicLink()
                            .setLink(Uri.parse("https://maheshwari.com/?"+ URLEncoder.encode(params,"UTF-8")))
                                    .setDomainUriPrefix("https://grocerystore.page.link")
                                    .buildShortDynamicLink()
                                    .addOnCompleteListener(ProductViewActivity.this, new OnCompleteListener<ShortDynamicLink>() {
                                        @Override
                                        public void onComplete(@NonNull Task<ShortDynamicLink> task) {
                                            ...
                                            if (task.isSuccessful()) {
                                                ...
                                                shareProductText = "Check this out in Maheshwari Stores app!\n"+shortLink+"\nProduct - " + _title + "\n" + _attribute + " - " + _currency + _price + " (Discounted price - " +_currency  + _discount + ")";
                                            } else {
                                                shareProductText = "Check out this product in Maheshwari Stores app!\nProduct Name - " + _title + "\n" + _description + "\n" + _attribute + " - " + _currency + _price + " (Discounted price - " +_currency  + _discount + ")";

                                            }
                                            BitmapDrawable bitmapDrawable = ((BitmapDrawable) imageView.getDrawable());
                                            Bitmap bitmap = bitmapDrawable .getBitmap();
                                            String bitmapPath = MediaStore.Images.Media.insertImage(getContentResolver(), bitmap,"Product Image", null);
                                            Uri bitmapUri = Uri.parse(bitmapPath);
                                            Intent shareIntent=new Intent(Intent.ACTION_SEND);
                                            shareIntent.setType("*/*");
                                            shareIntent.putExtra(Intent.EXTRA_STREAM, bitmapUri);
                                            shareIntent.putExtra(Intent.EXTRA_TEXT, shareProductText);
        ...
        addToCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                cart = new Cart(_id, _title, _image, _currency, _price, _discount,_attribute, "1", _price);
                cartList.add(cart);
        ...
        inc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String subTotal = String.valueOf(Double.parseDouble(_discount) * total_item);
        ...
        switch (item.getItemId()) {
            ...
            case R.id.cart_action:
                ...
                if(getIntent().hasExtra("category")){
                    cartIntent.putExtra("category",cartIntent.getStringExtra("category"));
                    cartIntent.putExtra("activity_tag",ProductViewActivity.class.getSimpleName());
                }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menuItem.setIcon(Converter.convertLayoutToImage(ProductViewActivity.this, cartCount(), R.drawable.ic_shopping_basket));
        return true;
    }

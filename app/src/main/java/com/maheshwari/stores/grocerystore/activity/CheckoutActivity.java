...
import com.maheshwari.stores.grocerystore.fragment.AddressFragment;
...
public class CheckoutActivity extends BaseActivity {
    ...
    private void changeActionBarTitle(ActionBar actionBar) {
        ...
        Typeface tf = Typeface.createFromAsset(getApplicationContext().getAssets(), "fonts/OpenSans-Bold.ttf");
        tv.setTypeface(tf);
        tv.setTextSize(20);
    ...
    public void onBackPressed() {
        ...
        cartIntent.putExtras(getIntent().getExtras());

...
public class CheckoutCartAdapter extends RecyclerView.Adapter<CheckoutCartAdapter.MyViewHolder> {
    ...
    Context context;
    int pQuantity = 1;
    String _subtotal, _price, _quantity,_total;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        _total = String.valueOf(Double.parseDouble(cart.getPrice()) * Integer.parseInt(_quantity));
        _subtotal = String.valueOf(Double.parseDouble(cart.getDiscounted_price()) * Integer.parseInt(_quantity));

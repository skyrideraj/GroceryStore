...
import com.maheshwari.stores.grocerystore.adapter.ProductAdapter;
...
public class ProductActivity extends BaseActivity {
    ...
    public void openCartActivity(View view){
        ...
        cartIntent.putExtra("category",categoryName);
        cartIntent.putExtra("activity_tag",ProductActivity.class.getSimpleName());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menuItem.setIcon(Converter.convertLayoutToImage(ProductActivity.this, cartCount(), R.drawable.ic_shopping_basket));
        return true;
    }

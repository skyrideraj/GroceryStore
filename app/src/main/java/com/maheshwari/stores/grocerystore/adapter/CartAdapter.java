...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.MyViewHolder> {
    ...
    Context context;
    int pQuantity = 1;
    String _total,_subtotal, _price, _quantity, _discount;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        _discount = cart.getDiscounted_price();

        holder.quantity.setText(_quantity);
        holder.price.setText(Utils.getStrikeThroughTextForCartAdapter(_price,_discount));
        holder.currency.setText(cart.getCurrency());
        _total = String.valueOf(Double.parseDouble(_price) * Integer.parseInt(_quantity));
        _subtotal = String.valueOf(Double.parseDouble(_discount) * Integer.parseInt(_quantity));
        holder.subTotal.setText(Utils.getStrikeThroughTextForCartAdapter(_total,_subtotal));
                ...
                if (pQuantity >= 1) {
                    ...
                    for (int i = 0; i < cartList.size(); i++) {
                        ...
                        if (cartList.get(i).getId().equalsIgnoreCase(cart.getId())) {
                            ...
                            _total = String.valueOf(Double.parseDouble(cartList.get(i).getPrice()) * total_item);
                            _subtotal = String.valueOf(Double.parseDouble(cartList.get(i).getDiscounted_price()) * total_item);
